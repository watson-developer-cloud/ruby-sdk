...
class WatsonDeveloperCloud::ToneAnalyzerV3 < WatsonService
  ...
  #
  #   **`2016-05-19`:** A comma-separated list of tones for which the service is to return
  #   its analysis of the input; the indicated tones apply both to the full document and
  #   to individual sentences of the document. You can specify one or more of the valid
  #   values. Omit the parameter to request results for all three tones.
  # @param content_language [String]  The language of the input text for the request: English or French. Regional variants
  #   are treated as their parent language; for example, `en-US` is interpreted as `en`.
  #   The input content must match the specified language. Do not submit content that
  #   contains both languages. You can use different languages for **Content-Language**
  #   and **Accept-Language**.
  ...
  #
  #   If you submit more than 50 utterances, the service returns a warning for the overall
  #   content and analyzes only the first 50 utterances. If you submit a single utterance
  #   that contains more than 500 characters, the service returns an error for that
  #   utterance and does not analyze the utterance. The request fails if all utterances
  #   have more than 500 characters.
  #
  #   Per the JSON specification, the default character encoding for JSON content is
  #   effectively always UTF-8.
  # @param utterances [Array[Utterance]]  An array of `Utterance` objects that provides the input content that the service is
  #   to analyze.
  # @param content_language [String]  The language of the input text for the request: English or French. Regional variants
  #   are treated as their parent language; for example, `en-US` is interpreted as `en`.
  #   The input content must match the specified language. Do not submit content that
