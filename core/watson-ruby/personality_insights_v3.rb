...
class PersonalityInsightsV3 < WatsonService
  ...
  def profile(content:, content_type:, accept: nil, content_language: nil, accept_language: nil, raw_scores: nil, csv_headers: nil, consumption_preferences: nil)
    ...
    # :param String content_type: The type of the input: application/json, text/html, or text/plain. A character
    #   encoding can be specified by including a `charset` parameter. For example,
    #   'text/html;charset=utf-8'.
    # :param String accept: The type of the response: application/json or text/csv. A character encoding can
    #   be specified by including a `charset` parameter. For example,
    #   'text/csv;charset=utf-8'.
    # :param String content_language: The language of the input text for the request: Arabic, English, Japanese, Korean,
    ...
    # :param String accept_language: The desired language of the response. For two-character arguments, regional
    ...
    #   content.
    # :param Boolean raw_scores: Indicates whether a raw score in addition to a normalized percentile is returned
    ...
    # :param Boolean csv_headers: Indicates whether column labels are returned with a CSV response. By default, no
    #   column labels are returned. Applies only when the **Accept** parameter is set to
    #   `text/csv`.
    # :param Boolean consumption_preferences: Indicates whether consumption preferences are returned with the results. By
