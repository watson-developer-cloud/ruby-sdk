...
class ToneAnalyzerV3 < WatsonService
  ...
  def tone(tone_input:, content_type:, sentences: nil, tones: nil, content_language: nil, accept_language: nil)
    ...
    #
    # :param ToneInput tone_input: JSON, plain text, or HTML input that contains the content to be analyzed. For JSON
    #   input, provide an object of type `ToneInput`.
    # :param String content_type: The type of the input: application/json, text/plain, or text/html. A character
    #   encoding can be specified by including a `charset` parameter. For example,
    #   'text/plain;charset=utf-8'.
    # :param Boolean sentences: Indicates whether the service is to return an analysis of each individual sentence
    #   in addition to its analysis of the full document. If `true` (the default), the
    #   service returns results for each sentence.
    # :param list[String] tones: **`2017-09-21`:** Deprecated. The service continues to accept the parameter for
    ...
    # :param String content_language: The language of the input text for the request: English or French. Regional
  ...
  def tone_chat(utterances:, content_language: nil, accept_language: nil)
    ...
    #
    # :param list[Utterance] utterances: An array of `Utterance` objects that provides the input content that the service
    #   is to analyze.
    # :param String content_language: The language of the input text for the request: English or French. Regional
    #   variants are treated as their parent language; for example, `en-US` is interpreted
    #   as `en`. The input content must match the specified language. Do not submit
